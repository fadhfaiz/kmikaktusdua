...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Bulan Mei 2019 pada 10.13
...
--
-- Dumping data untuk tabel `site_log`
--
...
--
-- AUTO_INCREMENT untuk tabel `site_log`
--
ALTER TABLE `site_log`
  MODIFY `site_log_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=659;
