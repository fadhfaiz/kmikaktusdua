<section class="container">
    ...
    <div class="row mt-3">
        <div class="col-6"></div>
        <div class="col-3"><input type="button" value="Kembali" class="btn btn-outline-info btn-block"></div>
        <div class="col-3"><input type="button" value="Checkout" class="btn btn-success btn-block"></div>
    </div>
</section>
