<section class="container">
	...
	<div class="row">
		<div class="col-lg-6 col-md-12 col-sm-12 mt-4 mb-5">
			<img src="<?php echo base_url().'assets/img/'.$tanaman->gambar?>" class="img-fluid" alt="Responsive image">
		</div>

		<div class="col-lg-6 col-md-12 col-sm-12 mt-4 mb-5">
			<div class="text-center font-weight-bold">
				<h1><?php echo $tanaman->nama_tanaman;?></h1>
			</div>
			<div class="text-center text-muted font-italic">
				<h6><?php echo $tanaman->kode_tanaman;?></h6>
			</div>
			<div class="text-center" class="h3">Rp. <?php echo $tanaman->harga;?></a></div>
				...
				<table class="table table-hover table-borderless table-responsive">
					<tbody>
						<tr>
							...
							<td>:</td>
							<td><?php echo $tanaman->stok;?> pcs</td>
						</tr>
						<tr>
							<th scope="row">Diameter Pot</th>
							<td>:</td>
							<td><?php echo $tanaman->diameter;?> cm</td>
						</tr>
						<tr>
							<th scope="row">Tinggi Tanaman</th>
							<td>:</td>
							<td><?php echo $tanaman->tinggi;?> cm</td>
						</tr>
					</tbody>
				</table>
			</div>
