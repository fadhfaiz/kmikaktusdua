<section class="container">
	...
	<div class="row">
		<div class="col-lg-6 col-md-12 col-sm-12 mt-4 mb-5">
			<img src="<?php echo base_url().'assets/img/'.$aksesoris->gambar?>" class="img-fluid" alt="Responsive image">
		</div>

		<div class="col-lg-6 col-md-12 col-sm-12 mt-4 mb-5">
			<div class="text-center font-weight-bold">
				<h1><?php echo $aksesoris->nama;?></h1>
			</div>
			<div class="text-center text-muted font-italic">
				<h6><?php echo $aksesoris->kode_aksesoris;?></h6>
			</div>
			<div class="text-center" class="h3">Rp. <?php echo $aksesoris->harga;?></a></div>
				...
				<table class="table table-hover table-borderless table-responsive">
					<tbody>
						<tr>
							...
							<td>:</td>
							<td><?php echo $aksesoris->stok;?> pcs</td>
						</tr>
					</tbody>
				</table>
			</div>
