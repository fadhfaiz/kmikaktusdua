<section class="container my-4">
	...
	<?php echo form_open('Pembelian'); ?>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('catatan'); ?></small>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('provinsi'); ?></small>
					</div>
				</div>
				<div class="col-lg-6 col-sm-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('kabupaten'); ?></small>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('kecamatan'); ?></small>
					</div>
				</div>
				<div class="col-lg-6 col-sm-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('kodepos'); ?></small>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="form-group">
						...
						<small id="" class="form-text text-danger"><?= form_error('alamatlengkap'); ?></small>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-6"><button type="submit" class="btn btn-block btn-warning" name="tambahpembeli">Detail Pesanan</button></div>
