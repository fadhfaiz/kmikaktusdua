<section class="container my-4">
	<form action="">
        ...
        <div class="col-6 my-2"><a href="<?= base_url(); ?>pembelian/menunggu_ongkir" class="btn btn-success btn-block align-right">Detail Pesanan <i class="fas fa-arrow-circle-right fa-lg"></i></a></div>
        </div>
	</form>
</section>
